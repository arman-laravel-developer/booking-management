...
<div class="wrapper">
    ...
    <div class="navbar-custom topnav-navbar">
        <div class="container-fluid detached-nav">
            ...
            <a href="{{route('home')}}" target="_blank" class="btn btn-primary mt-2"><i class="uil-home-alt"></i></a>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarTasks">
                        <ul class="side-nav-second-level">
                            <li>
                                <a href="{{route('hostel.add')}}">Hostel Add</a>
                            </li>
                            <li>
                                <a href="{{route('hostel.manage')}}">Hostel Manage</a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © Hotel Management System
                    </div>
                </div>
            </div>
        </footer>
